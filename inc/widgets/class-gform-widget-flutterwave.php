...
class GF_FlutterWave_Credit_Card_Field extends \GF_Field {
    ...
    public function get_form_editor_field_icon() {
        $icon = file_get_contents(WOOFLUTTER_BUILD_PATH . '/icons/money-business-and-finance-svgrepo-com.svg');
            ...
            <div class="flutterwaves_credit_card" style="<?php echo esc_attr(($this->flutterwaveDefaultModeCard == true)?'display: flex;':'display: none;'); ?>">
                <div class="creditcard_container preload <?php echo esc_attr(($this->enablePreviewField)?'':'d-none'); ?>">
                    <div class="creditcard">
                        <div class="front">
                            <div id="ccsingle"></div>
                            <?php
                                $icon = WOOFLUTTER_BUILD_PATH . '/icons/sample-credit-card-front.svg';
                        ...
                        <div class="back">
                            <?php
                                $icon = WOOFLUTTER_BUILD_PATH . '/icons/sample-credit-card-back.svg';
                ...
                <div class="form-container">
                    ...
                    <div class="field-container">
                        ...
                        <span id="generatecard" class="<?php echo esc_attr(WOOFLUTTER_TEST_MODE?'':'d-none'); ?>"><?php esc_html_e('generate random', 'gravitylovesflutterwave'); ?></span>
